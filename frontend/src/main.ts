...
const unsetupMatomo = (): void => {
  console.log("UNSETUP MATOMO DEPENDING ON COOKIE CONSENT");
...
const checkAnalyticsAndSetupMatomo = (): void => {
  try {
    const acceptedCategories: CookieConsent.CookieValue = window.CookieConsent.getCookie();
    ...
    translations: {
      fr: {
        consentModal: {
          ...
          description:
            "Nous utilisons des cookies pour garantir le bon fonctionnement du site, personnaliser votre expérience et analyser notre trafic. Vous pouvez choisir les cookies que vous souhaitez autoriser.",
          ...
          sections: [
            {
              ...
              description:
                "Nous utilisons différents types de cookies pour optimiser votre navigation et améliorer notre service.",
            },
            {
              title: "Cookies strictement nécessaires",
              description:
                "Ces cookies sont indispensables au bon fonctionnement du site. Ils sont activés en permanence.",
              linkedCategory: "necessary",
            },
            {
              title: "Cookies de performance et d'analyse",
              description:
                "Ces cookies nous permettent de mieux comprendre comment le site est utilisé et d'améliorer son contenu. Toutes les données collectées sont anonymes.",
              linkedCategory: "analytics",
            },
            {
              title: "Besoin d'aide ?",
              description:
                "Pour en savoir plus sur l'utilisation des cookies ou exercer vos droits, contactez-nous.",
            },
          ],
        },
      },
